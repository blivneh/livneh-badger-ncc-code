...
for(f in 1:n.swe.files){
	...
	output.file = paste(output.dir,print.names[f],"_POINT_STATS",sep='')
	output.file2 = paste(output.dir,print.names[f],"_THREAT_SCORE_Preds_SWE",sep='')
	output.file3 = paste(output.dir,print.names[f],"_POINT_STATS_Goodness_Of_Fit",sep='')
